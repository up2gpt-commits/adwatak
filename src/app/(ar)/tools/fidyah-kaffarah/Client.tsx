...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      seoContent=[
  "احسب الفدية عن صيام رمضان الفائت.",
  "حدد مقدار الكفارة بسهولة.",
  "بناءً على الأحكام الإسلامية والأسعار المحلية.",
  "أدِّ واجباتك الدينية بدقة.",
  "حاسبة مجانية للفدية والكفارة عبر الإنترنت.",
];
