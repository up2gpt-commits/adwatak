...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      seoContent=[
  "اعثر على اتجاه القبلة الدقيق من أي مكان.",
  "استخدم الخريطة أو البوصلة لتحديد موقع الكعبة.",
  "اتجاه دقيق بناءً على نظام تحديد المواقع (GPS) الخاص بك.",
  "ضروري للصلوات اليومية والسفر.",
  "مُحدد اتجاه القبلة مجاني عبر الإنترنت.",
];
