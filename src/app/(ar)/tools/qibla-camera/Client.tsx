...
const seoContent = [
  `كاميرا القبلة هي أداة ذكية تعرض سهماً أخضر فوق الكاميرا المباشرة لتوضيح اتجاه الكعبة المشرفة بدقة في أي مكان. تساعدك هذه التقنية المتطورة على تحديد قبلة الصلاة بسهولة عبر الواقع المعزز والتوجيه المرئي المباشر.`,
  `تعتمد الأداة على نظام تحديد المواقع GPS والبوصلة الرقمية لحساب المسار الدائري الأقصر نحو مكة المكرمة بشكل آني. يقوم التطبيق بمعالجة بيانات الموقع والزاوية لرسم خط المسار الأمثل الذي يصلك إلى الكعبة بدقة عالية.`,
  `لتحقيق أفضل نتيجة، حرك جهازك بحركة رقم 8 في الهواء لمعايرة البوصلة، وتجنب الاقتراب من الأجسام المعدنية التي تؤثر على المجال المغناطيسي. يُفضل إعادة المعايرة عند الانتقال إلى مدينة جديدة لتحديث حسابات الاتجاه بما يتوافق مع إحداثيات الموقع الجديد.`,
  `يستهلك استخدام كاميرا القبلة النشط نحو 6 إلى 8% من شحن البطارية كل 15 دقيقة نظراً لتشغيل الكاميرا والحساسات في آن واحد. لتقليل استهلاك الطاقة، خفض سطوع الشاشة أثناء الاستخدام أو أغلق التطبيقات العاملة في الخلفية غير الضرورية.`,
  `تتوافق أداة كاميرا القبلة مع أجهزة iPhone 8 والإصدارات الأحدث، بالإضافة إلى هواتف Android 8.0 فما فوق المزودة بمستشعر الجيروسكوب. تأكد من تحديث نظام تشغيل جهازك والتحقق من توفر حساس الدوران لضمان أداء دقيق ومستقر.`,
];

const faqs = [
  { question: "ما مدى دقة كاميرا تحديد القبلة؟", answer: "دقة الكاميرا في تحديد القبلة تبلغ حوالي ±2 درجة في الظروف المثالية. تعتمد الدقة على جودة مستشعرات جهازك وعدم وجود تداخلات مغناطيسية قريبة." },
  { question: "هل يعمل تطبيق كاميرا القبلة بدون إنترنت؟", answer: "نعم، بمجرد تحميل الصفحة يمكنك استخدامها بدون اتصال بالإنترنت. تعتمد وظيفة الكاميرا والبوصلة على مستشعرات الجهاز الداخلية التي لا تحتاج لشبكة." },
  { question: "كيف يمكن معايرة البوصلة للحصول على نتائج دقيقة؟", answer: "قم بتحريك جهازك بحركة على شكل رقم ثمانية لمدة 15 ثانية على الأقل. هذه الحركة تساعد في إعادة ضبط المستشعر المغناطيسي وتحسين دقة اتجاه القبلة." },
  { question: "هل يعمل التطبيق على أجهزة Android و iPhone؟", answer: "نعم، يدعم التطبيق أجهزة iPhone 8 وما هو أحدث، بالإضافة إلى أجهزة Android 8.0 وما فوق. تأكد من تحديث نظام تشغيل جهازك للحصول على أفضل أداء." },
  { question: "هل يجب تشغيل خدمة تحديد الموقع GPS؟", answer: "نعم، يُفضل تشغيل GPS للحصول على اتجاه دقيق للقبلة. الموقع الجغرافي يساعد في حساب زاوية القبلة الصحيحة من مكان تواجدك الحالي." },
  { question: "ماذا أفعل إذا استمر السهم في الدوران بلا توقف؟", answer: "جرب معايرة البوصلة بحركة رقم ثمانية وابتعد عن الأجسام المعدنية والإلكترونية. التداخلات المغناطيسية القريبة تسبب اضطراباً في قراءة المستشعرات." },
  { question: "ما الفرق بين هذا التطبيق وتطبيقات البوصلة العادية؟", answer: "يستخدم تطبيق كاميرا القبلة تقنية الواقع المعزز لعرض اتجاه القبلة مباشرة على الصورة الحية من الكاميرا. هذا يوفر تجربة أدق وأسهل من قراءة البوصلة التقليدية." },
  { question: "هل الانحراف المغناطيسي يؤثر على دقة التطبيق؟", answer: "لا، يتم تصحيح الانحراف المغناطيسي تلقائياً باستخدام بيانات GPS لموقعك الحالي. هذا يضمن أن الاتجاه المعروض هو القبلة الصحيحة وليس الشمال المغناطيسي فقط." },
  { question: "كم يستهلك التطبيق من البطارية؟", answer: "يستهلك التطبيق حوالي 6 إلى 8% من البطارية كل 15 دقيقة استخدام. الاستخدام المستمر للكاميرا والمستشعرات يستهلك طاقة أكثر من التطبيقات العادية." },
  { question: "هل يمكنني استخدام التطبيق داخل المنزل بالقرب من المعادن؟", answer: "يُنصح بتجنب وجود معادن أو أجهزة إلكترونية على بعد 3 أقدام (حوالي متر) أثناء الاستخدام. المعادن القريبة تسبب تشويشاً في قراءة البوصلة وقد تنحرف الإشارة بمقدار 15 درجة." },
];

const relatedTools = [
  { title: "اتجاه القبلة", icon: "🧭", href: "/tools/qibla-direction" },
  { title: "التقويم الهجري", icon: "📅", href: "/tools/hijri-converter" },
  ...
  { title: "الفدية والكفارة", icon: "🌲", href: "/tools/fidyah-kaffarah" },
];
