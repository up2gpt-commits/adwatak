...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      seoContent=[
  "قدّر تكاليف رحلة العمرة بدقة.",
  "تشمل تذاكر الطيران والفنادق والتأشيرات والمزيد.",
  "خطط لميزانية عمرتك بسهولة.",
  "خصص حسب حجم العائلة والتفضيلات.",
  "حاسبة تكاليف العمرة المجانية عبر الإنترنت.",
];
