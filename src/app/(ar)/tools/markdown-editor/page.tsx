...
export default function MarkdownEditor() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{name:"الرئيسية",url:"https://adwatak.cloud"},{name:"أدوات مطورين",url:"https://adwatak.cloud/tools/dev"},{name:"محرر ماركداون",url:"https://adwatak.cloud/tools/markdown-editor"}])} />
      <Breadcrumb lang="ar" category="أدوات مطورين" categorySlug="dev" toolName="محرر ماركداون" />
