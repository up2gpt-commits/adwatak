...
export default function Client() {
  ...
  "جدول الصلاة اليومي مع تذكيرات الأذان.",
  "طرق حساب قابلة للتعديل حول العالم.",
  "لا تفوّت أبدًا صلاة الفجر والظهر والعصر والمغرب والعشاء.",
  "أداة مجانية لأوقات الصلاة الإسلامية عبر الإنترنت.",
];
