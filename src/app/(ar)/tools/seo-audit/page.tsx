...
export default function SEOAudit() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{name:"الرئيسية",url:"https://adwatak.cloud"},{name:"أدوات تطوير",url:"https://adwatak.cloud/tools/dev"},{name:"SEO Audit",url:"https://adwatak.cloud/tools/seo-audit"}])} />
