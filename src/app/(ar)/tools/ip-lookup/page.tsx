...
export default function IPLookup() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{name:"الرئيسية",url:"https://adwatak.cloud"},{name:"أدوات مطورين",url:"https://adwatak.cloud/tools/dev"},{name:"البحث عن IP",url:"https://adwatak.cloud/tools/ip-lookup"}])} />
      <Breadcrumb lang="ar" category="أدوات مطورين" categorySlug="dev" toolName="البحث عن IP" />
