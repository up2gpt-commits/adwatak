...
export default function NameGenerator() {
  ...
  const generate = () => {
    const pool = lang === "ar" ? (gender === "male" ? arabicMale : arabicFemale) : (gender === "male" ? englishMale : englishFemale);
    const result: string[] = [];
...
const schemaUrl = "https://adwatak.cloud/tools/name-generator";
const breadcrumbItems = [
  { name: "الرئيسية", url: "https://adwatak.cloud" },
  { name: "Utility", url: "https://adwatak.cloud/tools/utility" },
  { name: "مولد أسماء", url: "https://adwatak.cloud/tools/name-generator" },
];
return (
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div>
            ...
            <select value={lang} onChange={(e) => setLang(e.target.value)}
              ...
              <option value="ar">عربي</option><option value="en">إنجليزي</option>
            </select>
          </div>
          <div>
