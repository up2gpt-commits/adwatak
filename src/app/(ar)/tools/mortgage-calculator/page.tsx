...
import { generateToolMetadata, generateBreadcrumbSchema } from "@/app/lib/tool-metadata";
import MortgageCalculatorClient from "./MortgageCalculatorClient";

// ── SEO Metadata ──
export const metadata: Metadata = generateToolMetadata("mortgage-calculator", "ar")!;

// ── Static data ──
const title = "حاسبة القرض العقاري";
const icon = "🏠";
const desc = "احسب القسط الشهري وإجمالي الفائدة وجدول سداد القرض العقاري — مجاناً وبالعربي";
const schemaCategory = "Finance";
const schemaUrl = "https://adwatak.cloud/tools/mortgage-calculator";
const breadcrumbItems = generateBreadcrumbSchema("mortgage-calculator", "ar")!;
...
const faqs = [
  ...
  },
  {
    ...
    answer: "وفقاً للوائح البنك المركزي، يجب ألا يتجاوز الاقتطاع الشهري للقرض العقاري 40% من إجمالي الراتب الشهري. هذا يشمل أقساط جميع القروض مجتمعة."
  },
  {
    question: "ما هو جدول الاستفلال (Amortization Schedule)؟",
    answer: "جدول الاستفلال يوضح تفاصيل كل قسط شهري خلال مدة القرض — كم يذهب لأصل الدين وكم للفائدة. في السنوات الأولى، يذهب الجزء الأكبر من القسط للفائدة. في السنوات الأخيرة، يذهب معظم القسط لأصل الدين."
  },
  {
    question: "هل يشمل التمويل العقاري التأمين على الحياة؟",
    answer: "نعم، تطلب البنوك السعودية تأمين على الحياة (تأمين تكافلي) يغطي رصيد القرض في حالة الوفاة أو العجز الكلي. تكلفة التأمين تتراوح بين 0.5% إلى 1% من رصيد القرض سنوياً."
  },
  {
    question: "كم يستغرق القرض العقاري من الموافقة إلى الصرف؟",
    answer: "تستغرق عملية الموافقة على القرض العقاري من أسبوعين إلى 3 شهور حسب البنك ونوع التمويل وتعقيدات الملكية."
  },
  {
    question: "ما الفرق بين التمويل التقليدي والتمويل الإسلامي للعقار؟",
    answer: "التمويل التقليدي يعتمد على الفائدة (ربا). التمويل الإسلامي يستخدم صيغاً شرعية مثل المرابحة (البنك يشتري العقار ويبيعه عليك بربح معلوم) أو الإجارة المنتهية بالتمليك. في السعودية، التمويل الإسلامي هو السائد."
  },
  {
    question: "هل يمكن الحصول على قرض عقاري للمقيمين في السعودية؟",
    answer: "نعم، يمكن للمقيمين الحصول على تمويل عقاري بشروط تختلف حسب القيمة المطلوبة ومدة الإقامة."
  },
  {
    question: "لماذا تستخدم الحاسبة 12 شهراً في حساب الفائدة الشهرية؟",
    answer: "لأن الفائدة السنوية تقسم على 12 شهراً للحصول على الفائدة الشهرية. معظم القروض العقارية في السعودية تحتسب الفائدة شهرياً وليس سنوياً."
  },
  {
    question: "ما هي أفضل بنوك للقرض العقاري في السعودية؟",
    answer: "أشهر بنوك التمويل العقاري في السعودية: البنك الأهلي السعودي (أكبر محفظة عقارية)، مصرف الراجحي (التمويل الإسلامي)، بنك الرياض، البنك العربي الوطني، بنك الجزيرة."
  },
];
...
const seoContent = [
  ...
  "التأمين على القرض العقاري: تطلب البنوك وثيقة تأمين تكافلي على الحياة تغطي رصيد القرض في حالة الوفاة أو العجز الكلي. التكلفة السنوية حوالي 0.5% من رصيد القرض.",
];
