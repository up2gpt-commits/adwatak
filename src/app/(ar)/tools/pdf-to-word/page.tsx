...
const faqs = [
  { question: "ما هي PDF إلى Word؟", answer: "أداة مجانية تحويل ملفات PDF إلى نصوص Word قابلة للتعديل. تعمل مباشرة في المتصفح بدون رفع ملفات. خصوصيتك مضمونة." },
...
const seoContent = [
  "أداة PDF إلى Word مجانية بالكامل. تحويل ملفات PDF إلى نصوص Word قابلة للتعديل. تعمل في متصفحك مباشرة.",
...
export default function ToolPage() {
  return (
    <div className="max-w-[760px] mx-auto">
      <StructuredData data={toolSchema("PDF إلى Word", "تحويل ملفات PDF إلى نصوص Word قابلة للتعديل", "https://adwatak.cloud/tools/pdf-to-word", "ar", "Tools")} />
      <StructuredData data={faqSchema(faqs)} />
      <Breadcrumb lang="ar" category="أدوات" categorySlug="tools" toolName="PDF إلى Word" />
      <div className="bg-white rounded-2xl border border-gray-200 p-8 mb-6">
        <h1 className="text-2xl font-extrabold mb-1">📄 PDF إلى Word</h1>
        <p className="text-sm text-gray-500 mb-6">تحويل ملفات PDF إلى نصوص Word قابلة للتعديل</p>
