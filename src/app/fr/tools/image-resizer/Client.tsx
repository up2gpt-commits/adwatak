...
{question:"Est-ce totalement gratuit ?",answer:"Oui, 100 % gratuit. Pas d'inscription, pas de limites, pas de filigranes."},
{question:"Maximum image size?",answer:"Jusqu'à 20 mégapixels. Les images plus grandes peuvent ralentir le navigateur."},
{question:"Cela fonctionne-t-il sur mobile ?",answer:"Oui, entièrement responsive et fonctionne sur tous les appareils."},
{question:"Comment l'utiliser ?",answer:"Téléchargez une image, définissez la nouvelle largeur/hauteur, activez le verrouillage des proportions et cliquez sur Redimensionner. Aperçu et téléchargement du résultat."},
{question:"Puis-je agrandir des images ?",answer:"Oui, mais l'agrandissement peut réduire la qualité car l'outil interpole les pixels plutôt que d'ajouter des détails réels."},
{question:"Quelle est la différence entre redimensionner et compresser ?",answer:"Redimensionner modifie les dimensions. Compresser réduit la taille du fichier tout en conservant les dimensions. Utilisez les deux pour de meilleurs résultats."},
{question:"Quel est le meilleur format pour le web ?",answer:"WebP : 25 à 35 % plus petit que JPG avec la même qualité. Tous les navigateurs modernes le prennent en charge. JPG est universellement pris en charge."},
];
const relatedTools=[
