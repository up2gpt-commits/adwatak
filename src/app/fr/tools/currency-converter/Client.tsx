...
const faqs = [
  ...
  { question: "Qu'est-ce que le spread achat/vente ?", answer: "Prix d'achat = taux auquel la banque vous vend la devise. Prix de vente = taux auquel la banque vous rachète la devise. La différence est la marge bénéficiaire de la banque (spread). Notre outil affiche le taux moyen." },
