...
const faqs = [
  { question: "Marge brute vs marge nette ?", answer: "Gross margin only accounts for direct cost of goods. Net margin subtracts everything — overhead, marketing, taxes. A cafe might have 70% gross margin on coffee but only 10% net after rent and staff. Both matter for different decisions." },
  { question: "Qu'est-ce qu'une bonne marge bénéficiaire ?", answer: "Depends on industry: restaurants 3-9%, software 15-25%, retail 2-5%, consulting 20-40%, manufacturing 5-15%. A 5% net margin is solid for grocery but terrible for consulting. Benchmark against your specific industry." },
  { question: "Taux de marque vs marge — quelle est la différence ?", answer: "Markup = profit / cost × 100. Margin = profit / price × 100. $60 cost, $100 price: markup = 66.7%, margin = 40%. If you want 40% margin, you must mark up by 66.7% — not 40%. This is the most common pricing mistake." },
  { question: "Comment calculer le prix de vente à partir de la marge ?", answer: "Selling Price = Cost ÷ (1 - Desired Margin). Example: cost = $60, desired margin = 40%. Price = $60 ÷ 0.6 = $100. If you want 50% margin: $60 ÷ 0.5 = $120. Always calculate margin this way, not by adding a percentage to cost." },
  { question: "Comment calculer le coût à partir du prix et de la marge ?", answer: "Cost = Price × (1 - Margin). Example: selling at $100, want 40% margin. Max cost = $100 × 0.6 = $60. If your cost is higher than $60, you can't achieve 40% margin at $100 price. Either raise price or lower costs." },
  { question: "Qu'est-ce qu'une marge bénéficiaire saine pour une startup ?", answer: "For SaaS startups, 20-40% net margin at scale is excellent. Early stage: focus on 60-80% gross margins (common for SaaS). If gross margin is below 50%, your pricing model or cost structure needs serious review before scaling." },
  { question: "Comment calculer le point mort ?", answer: "Break-Even = Fixed Costs ÷ Contribution Margin per Unit. Contribution Margin = Price - Variable Cost per Unit. Example: fixed costs $10,000, price $100, variable cost $60 → CM = $40 → BE = 250 units. Every sale after 250 = pure profit." },
  { question: "Quelle est la différence entre la marge brute et la marge sur coût variable ?", answer: "Gross margin = (Revenue - COGS) ÷ Revenue. Contribution margin = (Revenue - Variable Costs) ÷ Revenue. COGS is just the product cost. Contribution margin includes ALL variable costs (product + commissions + packaging + shipping). Contribution margin is more useful for pricing decisions." },
  ...
  { question: "Comment puis-je améliorer ma marge bénéficiaire ?", answer: "1) Negotiate with suppliers for lower costs. 2) Raise prices gradually. 3) Reduce inventory waste. 4) Sell higher-margin products alongside low-margin ones. 5) Bundle products instead of individual discounts. 6) Automate processes to cut operational costs. 7) Focus on repeat customers — they cost less to acquire." },
  { question: "La marge bénéficiaire peut-elle dépasser 100 % ?", answer: "Profit margin (margin %) can NEVER exceed 100% because it's profit ÷ price. Profit can't be larger than the price. However, markup CAN exceed 100%. Example: cost $10, price $100 → margin = 90%, markup = 900%. Don't confuse the two!" },
  { question: "Qu'est-ce qu'une bonne marge bénéficiaire pour le commerce électronique ?", answer: "E-commerce averages 10-20% net margin. Top performers hit 25-40%. The challenge: ads (10-30% of revenue), shipping (5-15%), returns (5-20%), payment processing (2-3%). To net 15%, you need at least 45% gross margin. Use this calculator to work backwards from your desired net margin." },
];
