...
const faqs = [
  ...
  { question: "Qu'est-ce que le Nisab ?", answer: "Le seuil minimum de richesse avant que la Zakat ne soit due. Nisab = valeur de 85 g d'or ou de 595 g d'argent (utilisez la valeur la plus basse, celle de l'argent, pour inclure davantage de personnes). En 2024 : environ 5 000 à 6 000 $ (85 g d'or) ou 500 à 600 $ (595 g d'argent). La plupart des savants recommandent le Nisab basé sur l'argent." },
  ...
  { question: "Quels biens sont exonérés de la Zakat ?", answer: "Primary residence, personal car, business equipment, household furniture, debts owed to others, salary before you receive it, retirement accounts (401k/IRA — unvested or inaccessible portions). Contested by some scholars." },
  ...
  { question: "Qui reçoit la Zakat ?", answer: "Eight categories from Quran 9:60: the poor, the needy, Zakat administrators, those whose hearts are to be reconciled, slaves/captives, those in debt, for Allah's cause (fi sabilillah), and the stranded traveler." },
  { question: "La Zakat peut-elle être payée à l'avance ?", answer: "Yes, you can pay Zakat before the year ends if you're sure wealth will stay above Nisab. Some scholars allow paying months in advance. Calculate at year-end and pay immediately — don't delay." },
  ...
  { question: "La Zakat peut-elle être donnée à la famille ?", answer: "Yes, to eligible relatives whom you're not financially obligated to support: siblings, cousins, aunts, uncles, in-laws. Not to parents, children, or spouse (you must support them anyway). Intention matters — give as Zakat, not a gift." },
  { question: "La Zakat peut-elle être donnée à des non-musulmans ?", answer: "According to Abu Hanifa and many contemporary scholars: Zakat can be given to poor non-Muslims, especially those in need. This builds community relations. Most scholars agree it can be given to 'those whose hearts are to be reconciled.'" },
];
