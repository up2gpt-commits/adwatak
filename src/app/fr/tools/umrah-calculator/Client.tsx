...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={faqSchema([
        ...
        { question: "Quelle est la différence entre la Omra et le Hajj ?", answer: "La Omra peut être accomplie à tout moment et n'est pas obligatoire. Le Hajj a lieu pendant des mois spécifiques et est l'un des cinq piliers de l'Islam." },
        ...
        { question: "Quel est le meilleur moment pour la Omra ?", answer: "Le Ramadan est le meilleur moment (la Omra pendant le Ramadan équivaut au Hajj en récompense). Évitez la saison du Hajj si vous voulez des prix plus bas." },
  ...
  "Calculateur de coût Omra gratuit en ligne.",
      ...
      <FAQSection faqs={[
        ...
        { question: "Quel est le meilleur moment pour la Omra ?", answer: "Le Ramadan est le meilleur moment (la Omra pendant le Ramadan équivaut au Hajj en récompense). Évitez la saison du Hajj pour des prix plus bas." },
