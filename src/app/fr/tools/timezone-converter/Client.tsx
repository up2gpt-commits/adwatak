...
export default function Client() {
  return (
    <div className="max-w-[760px] mx-auto">
      <StructuredData data={toolSchema("Coming Soon", "New tool", "https://adwatak.cloud/fr/tools/timezone-converter", "fr", "Tools")} />
      <Breadcrumb lang="fr" category="Tools" categorySlug="tools" toolName="Coming Soon" />
