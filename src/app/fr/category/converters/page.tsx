...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://adwatak.cloud/fr/category/converters",
    languages: {
      "ar": "https://adwatak.cloud/category/converters",
      "fr": "https://adwatak.cloud/fr/category/converters",
...
const tools = [
  { title: "PDF Merger", icon: "📎", href: "/fr/tools/pdf-merger", desc: "Combine multiple PDFs into one" },
  { title: "Image to PDF", icon: "🖼️", href: "/fr/tools/image-to-pdf", desc: "Convert images to PDF" },
  { title: "Unit Converter", icon: "📐", href: "/fr/tools/unit-converter", desc: "Length, weight, volume, temperature" },
  { title: "Color Converter", icon: "🎨", href: "/fr/tools/color-converter", desc: "HEX ↔ RGB ↔ HSL with preview" },
];
