...
const tools = [
  { title: "Mortgage Calculator", icon: "🏠", href: "/fr/tools/mortgage-calculator", desc: "Calculate monthly payments and amortization" },
  { title: "Loan Calculator", icon: "💰", href: "/fr/tools/loan-calculator", desc: "Personal loan payment calculator" },
  { title: "EMI Calculator", icon: "🧮", href: "/fr/tools/emi-calculator", desc: "Equated Monthly Installment" },
  { title: "Compound Interest", icon: "📈", href: "/fr/tools/compound-interest", desc: "Investment growth calculator" },
  { title: "Profit Margin", icon: "📐", href: "/fr/tools/profit-margin", desc: "Margin and markup calculator" },
  { title: "Salary Calculator", icon: "💵", href: "/fr/tools/salary-calculator", desc: "Gross to net salary" },
];
