...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://adwatak.cloud/fr/category/generators",
    languages: {
      "ar": "https://adwatak.cloud/category/generators",
      "fr": "https://adwatak.cloud/fr/category/generators",
...
const tools = [
  { title: "QR Code Generator", icon: "🔳", href: "/fr/tools/qr-generator", desc: "Create QR codes for URLs or text" },
  { title: "WhatsApp Link", icon: "💬", href: "/fr/tools/whatsapp-link", desc: "Direct chat link with pre-filled message" },
  { title: "Password Generator", icon: "🔐", href: "/fr/tools/password-generator", desc: "Secure random passwords" },
  { title: "Invoice Generator", icon: "🧾", href: "/fr/tools/invoice-generator", desc: "Professional invoice creator" },
  { title: "Random Number Generator", icon: "🎲", href: "/fr/tools/random-number", desc: "Random numbers within a range" },
  { title: "Name Generator", icon: "👤", href: "/fr/tools/name-generator", desc: "Arabic and English name generator" },
  { title: "Barcode Generator", icon: "📊", href: "/fr/tools/barcode-generator", desc: "Generate barcodes for products" },
];
