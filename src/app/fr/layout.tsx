...
export const metadata: Metadata = {
  title: {
    default: "Adwatak — Outils en Ligne Gratuits",
    template: "%s — Adwatak",
  },
  description: "Des outils en ligne gratuits pour tous — calculatrices, convertisseurs, générateurs et plus encore. 80+ outils. Sans inscription, sans publicité.",
  keywords: ["outils", "calculatrices", "convertisseurs", "générateurs", "outils gratuits", "outils en ligne"],
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    siteName: "Adwatak",
    title: "Adwatak — 80+ Outils en Ligne Gratuits",
    description: "Outils en ligne gratuits — calculatrices, convertisseurs, générateurs et plus encore. Sans inscription.",
    url: `${baseUrl}/fr`,
    images: [
      {
        url: `${baseUrl}/og-fr.png`,
        width: 1200,
        height: 630,
        alt: "Adwatak — 80+ Outils Gratuits",
      },
    ],
  },
  twitter: {
          ...
          <div className="footer-grid scroll-fade-in">
            ...
            <div className="footer footer-brand">
              ...
              <p className="footer-desc">
                Plateforme d'outils en ligne gratuits avec 80+ calculatrices, convertisseurs, générateurs et utilitaires — tout fonctionne dans votre navigateur. Sans inscription, sans téléchargement, sans pistage.
              </p>
              <div className="footer-social">
                ...
                <a href="mailto:contact@adwatak.cloud" title="Contact">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="footer">
              <h3>Catégories</h3>
              <a href="/#financial">💰 Calculatrices Financières</a>
              <a href="/#islamic">🕌 Outils Islamiques</a>
              <a href="/#text">📝 Outils de Texte</a>
              <a href="/#image">🖼️ Outils d'Image</a>
              <a href="/#pdf">📄 Outils PDF</a>
              <a href="/#converters">🔄 Convertisseurs</a>
              <a href="/#generators">⚡ Générateurs</a>
              <a href="/#dev">💻 Outils de Développement</a>
            </div>
            ...
            <div className="footer">
              ...
              <p style={{ fontSize: "0.82rem", color: "#94a3b8", marginBottom: "12px", lineHeight: "1.7" }}>
                Recevez une notification lors de l'ajout de nouveaux outils.
              </p>
              <NewsletterForm lang="fr" />
            </div>
          </div>

          <div className="copyright scroll-fade-in">
            © {new Date().getFullYear()} Adwatak — Tous droits réservés | adwatak.cloud | Pour tout le monde, partout 🌍
          </div>
        </div>
      </footer>
    </div>
