...
export default function NotFound() {
  ...
  if (isId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        <div className="text-7xl mb-4">🔧</div>
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Halaman Tidak Ditemukan</h1>
        <p className="text-gray-500 mb-8 max-w-md">Maaf, halaman yang Anda cari tidak ada.</p>
        <div className="flex gap-4">
          <Link href="/id" className="bg-blue-600 text-white font-bold px-6 py-3 rounded-xl no-underline hover:bg-blue-700 transition-colors">⬅️ Kembali ke Beranda</Link>
          <Link href="/id" className="bg-gray-100 text-gray-700 font-semibold px-6 py-3 rounded-xl no-underline hover:bg-gray-200 transition-colors">🗂️ Semua Alat</Link>
        </div>
      </div>
    );
  }
