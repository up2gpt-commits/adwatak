...
const relatedTools = [{title:"Profit Margin",icon:"📊",href:"/tr/tools/profit-margin"},{title:"VAT Calculator",icon:"🏛️",href:"/tr/tools/vat-calculator"},{title:"Compound Interest",icon:"📈",href:"/tr/tools/compound-interest"},{title:"BMI Calculator",icon:"⚖️",href:"/tr/tools/bmi-calculator"}];
...
export default function Client() {
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Percentage Calculator","Calculate percentages quickly","https://adwatak.cloud/tr/tools/percentage-calculator","en","Calculators")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="tr" category="Calculators" categorySlug="tools" toolName="Percentage Calculator"/>
    ...
    <SEOContent content={seo} lang="tr"/>
