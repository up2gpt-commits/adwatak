...
const relatedTools = [
  {title:"Unit Converter",icon:"🔄",href:"/tr/tools/unit-converter"},
  {title:"Color Converter",icon:"🎨",href:"/tr/tools/color-converter"},
  {title:"Currency Converter",icon:"💱",href:"/tr/tools/currency-converter"},
];
...
export default function Client(){
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Temperature Converter","Convert Celsius, Fahrenheit, Kelvin","https://adwatak.cloud/tr/tools/temperature-converter","en","Converters")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="tr" category="Converters" categorySlug="tools" toolName="Temperature Converter"/>
