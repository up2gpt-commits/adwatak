...
const T: Record<string, string> = {
  title: "Anahtar Kelime Araştırma Aracı",
  subtitle: "SEO'nuzu geliştirmek için doğru anahtar kelimeleri bulun",
  inputLabel: "Anahtar kelime veya konu",
  inputPlaceholder: "örn: emlak pazarlama, konut kredisi...",
  searchBtn: "🔍 Ara",
  searching: "⏳ Analiz ediliyor...",
  results: "Anahtar Kelime Sonuçları",
  noResults: "Anahtar kelime oluşturulamadı. Farklı bir terim deneyin.",
  ...
  medium: "Orta",
  high: "Yüksek",
  analysis: "Hızlı Analiz",
  totalKeywords: "Toplam Kelime",
  avgDifficulty: "Ort. Zorluk",
  easyWins: "Kolay Kazançlar",
  topRec: "En İyi Tavsiye",
  summary: "Özet",
};
...
export default function Client() {
  ...
  async function handleSearch() {
    ...
    try {
      const r = await fetch("/api/keyword-research", {
        ...
        body: JSON.stringify({ keyword: keyword.trim(), lang: "tr" }),
      });
  ...
  return (
    <div className="max-w-[820px] mx-auto">
      <StructuredData data={toolSchema("keyword-research", "Anahtar Kelime Aracı", "https://adwatak.cloud/tr/tools/keyword-research", "tr")} />
      <Breadcrumb lang="tr" category="SEO Araçları" categorySlug="seo" toolName="Anahtar Kelime" />
      ...
      {loading && (
        <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center mb-6">
          ...
          <p className="text-gray-500">Anahtar kelimeler analiz ediliyor...</p>
        </div>
      )}
