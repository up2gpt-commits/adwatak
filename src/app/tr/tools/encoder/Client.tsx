...
const relatedTools = [
  { title: "Base64 Encoder", icon: "🔄", href: "/tr/tools/base64-encoder" },
  { title: "JSON Formatter", icon: "📋", href: "/tr/tools/json-formatter" },
  { title: "Hash Generator", icon: "#️⃣", href: "/tr/tools/hash-generator" },
  { title: "مقارنة النصوص", icon: "⚖️", href: "/tr/tools/text-compare" },
  { title: "تنظيف النص", icon: "🧹", href: "/tr/tools/text-cleaner" },
  { title: "تحويل حالة النص", icon: "🔤", href: "/tr/tools/text-case" },
];
...
const breadcrumbItems = [
  ...
  { name: "أداة الترميز", url: "https://adwatak.cloud/tr/tools/encoder" },
];
return (
    <div className="max-w-[760px] mx-auto">
      ...
      />
      <Breadcrumb lang="tr" category="تطوير ويب" categorySlug="dev" toolName="أداة الترميز" />
