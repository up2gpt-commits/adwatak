...
const relatedTools = [
  {title:"Password Generator",icon:"🔑",href:"/tr/tools/password-generator"},
...
export default function ClientEn(){
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Encryption Tool","Encrypt and decrypt text","https://adwatak.cloud/tr/tools/encryption-tool","en","Developer Tools")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="tr" category="Developer Tools" categorySlug="tools" toolName="Encryption Tool"/>
