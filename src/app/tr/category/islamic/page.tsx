...
export const metadata: Metadata = {
  ...
  description: "Ücretsiz İslami araçlar: miras hesaplama, zekat hesaplama, Hicri çevirici",
};
...
export default function IslamicCategory() {
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 16px" }}>
      ...
      <p style={{ color: "#64748b", marginBottom: "32px", fontSize: "1.1rem" }}>Ücretsiz İslami araçlar: miras hesaplama, zekat hesaplama, Hicri çevirici</p>
