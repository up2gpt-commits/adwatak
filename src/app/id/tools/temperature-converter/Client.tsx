...
const relatedTools = [
  {title:"Unit Converter",icon:"🔄",href:"/id/tools/unit-converter"},
  {title:"Color Converter",icon:"🎨",href:"/id/tools/color-converter"},
  {title:"Currency Converter",icon:"💱",href:"/id/tools/currency-converter"},
];
...
export default function Client(){
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Temperature Converter","Convert Celsius, Fahrenheit, Kelvin","https://adwatak.cloud/id/tools/temperature-converter","en","Converters")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="id" category="Converters" categorySlug="tools" toolName="Temperature Converter"/>
