...
const relatedTools = [{title:"Profit Margin",icon:"📊",href:"/id/tools/profit-margin"},{title:"VAT Calculator",icon:"🏛️",href:"/id/tools/vat-calculator"},{title:"Compound Interest",icon:"📈",href:"/id/tools/compound-interest"},{title:"BMI Calculator",icon:"⚖️",href:"/id/tools/bmi-calculator"}];
...
export default function Client() {
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Percentage Calculator","Calculate percentages quickly","https://adwatak.cloud/id/tools/percentage-calculator","en","Calculators")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="id" category="Calculators" categorySlug="tools" toolName="Percentage Calculator"/>
