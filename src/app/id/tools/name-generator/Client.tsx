...
const relatedTools = [
  { title: "مولد أرقام عشوائية", icon: "🎲", href: "/id/tools/random-number" },
  { title: "مولد كلمات السر", icon: "🔐", href: "/id/tools/password-generator" },
  { title: "مولد الفواتير", icon: "🧾", href: "/id/tools/invoice-generator" },
  { title: "حاسبة العمر", icon: "🎂", href: "/id/tools/age-calculator" },
  { title: "مولد QR Code", icon: "🔳", href: "/id/tools/qr-generator" },
  { title: "رابط واتساب", icon: "💬", href: "/id/tools/whatsapp-link" },
];
...
export default function Client() {
  ...
  const generate = () => {
    const pool = lang === "id" ? (gender === "male" ? arabicMale : arabicFemale) : (gender === "male" ? englishMale : englishFemale);
    const result: string[] = [];
...
const schemaUrl = "https://adwatak.cloud/id/tools/name-generator";
const breadcrumbItems = [
  { name: "الرئيسية", url: "https://adwatak.cloud" },
  { name: "مولدات", url: "https://adwatak.cloud/category/calculators" },
  { name: "مولد أسماء", url: "https://adwatak.cloud/id/tools/name-generator" },
];
return (
    <div className="max-w-[760px] mx-auto">
      ...
      />
      <Breadcrumb lang="id" category="مولدات" categorySlug="generators" toolName="مولد أسماء" />
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div>
            ...
            <select value={lang} onChange={(e) => setLang(e.target.value)}
              ...
              <option value="id">عربي</option><option value="en">إنجليزي</option>
            </select>
          </div>
          <div>
