...
const relatedTools = [
  {title:"Age Calculator",icon:"🎂",href:"/id/tools/age-calculator"},
  {title:"Time Zone Converter",icon:"🌍",href:"/id/tools/timezone-converter"},
];
...
export default function ClientEn(){
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Date Duration Calculator","Calculate duration between two dates","https://adwatak.cloud/id/tools/date-duration","en","Daily Tools")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="id" category="Daily Tools" categorySlug="tools" toolName="Date Duration Calculator"/>
