...
const relatedTools = [
  {title:"Password Generator",icon:"🔑",href:"/id/tools/password-generator"},
...
export default function ClientEn(){
  ...
  return (<div className="max-w-[760px] mx-auto">
    <StructuredData data={toolSchema("Encryption Tool","Encrypt and decrypt text","https://adwatak.cloud/id/tools/encryption-tool","en","Developer Tools")}/>
    <StructuredData data={faqSchema(faqs)}/>
    <Breadcrumb lang="id" category="Developer Tools" categorySlug="tools" toolName="Encryption Tool"/>
