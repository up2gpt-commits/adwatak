...
export const metadata: Metadata = {
  ...
  description: "Alat Islami gratis: kalkulator waris, kalkulator zakat, konverter Hijriah",
};
...
export default function IslamicCategory() {
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 16px" }}>
      ...
      <p style={{ color: "#64748b", marginBottom: "32px", fontSize: "1.1rem" }}>Alat Islami gratis: kalkulator waris, kalkulator zakat, konverter Hijriah</p>
