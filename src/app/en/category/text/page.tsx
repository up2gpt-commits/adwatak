...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://adwatak.cloud/en/category/text",
    languages: {
      "ar": "https://adwatak.cloud/category/text",
      "en": "https://adwatak.cloud/en/category/text",
...
const tools = [
  { title: "Word Counter", icon: "📝", href: "/en/tools/word-counter", desc: "Count words, characters, and sentences" },
  { title: "Text Case Converter", icon: "🔤", href: "/en/tools/text-case", desc: "Upper, lower, title, sentence case" },
  { title: "Numbers to Words", icon: "🔢", href: "/en/tools/number-to-words", desc: "Convert numbers to English words" },
  { title: "Arabic Lorem Ipsum", icon: "📃", href: "/en/tools/arabic-lorem", desc: "Arabic placeholder text for designs" },
  { title: "Text Cleaner", icon: "🧹", href: "/en/tools/text-cleaner", desc: "Remove spaces, breaks, HTML tags" },
  { title: "Text Compare", icon: "⚖️", href: "/en/tools/text-compare", desc: "Compare two texts and find differences" },
  { title: "Plagiarism Checker", icon: "🚫", href: "/en/tools/plagiarism-checker", desc: "Check text originality" },
  { title: "Grammar Checker", icon: "✍️", href: "/en/tools/grammar-checker", desc: "Check spelling and punctuation" },
  { title: "Paraphrasing Tool", icon: "✏️", href: "/en/tools/paraphrasing-tool", desc: "Rewrite text in a new style" },
  { title: "AI Content Detector", icon: "🤖", href: "/en/tools/ai-content-detector", desc: "Detect AI vs human-written text" },
];
