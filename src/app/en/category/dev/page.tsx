...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://adwatak.cloud/en/category/dev",
    languages: {
      "ar": "https://adwatak.cloud/category/dev",
      "en": "https://adwatak.cloud/en/category/dev",
...
const tools = [
  { title: "JSON Formatter", icon: "📋", href: "/en/tools/json-formatter", desc: "Format and beautify JSON" },
  { title: "Base64 Encoder", icon: "🔄", href: "/en/tools/base64-encoder", desc: "Encode and decode Base64" },
  { title: "Hash Generator", icon: "#️⃣", href: "/en/tools/hash-generator", desc: "MD5, SHA-1, SHA-256, SHA-512" },
  { title: "SEO Audit", icon: "🔍", href: "/en/tools/seo-audit", desc: "Analyze your site's SEO health" },
  { title: "CSS Minifier", icon: "🎨", href: "/en/tools/css-minifier", desc: "Minify CSS files" },
  { title: "IP Lookup", icon: "🌐", href: "/en/tools/ip-lookup", desc: "Look up IP addresses and networks" },
  { title: "UUID Generator", icon: "🔑", href: "/en/tools/uuid-generator", desc: "Generate UUID v4 identifiers" },
  { title: "Encryption Tool", icon: "🔒", href: "/en/tools/encryption-tool", desc: "Caesar Cipher, Base64, text reversal" },
  { title: "Markdown Editor", icon: "📝", href: "/en/tools/markdown-editor", desc: "Write Markdown with live preview" },
  { title: "SEO Content Generator", icon: "🚀", href: "/en/tools/seo-content-generator", desc: "Generate 5 unique SEO articles from one keyword" },
];
