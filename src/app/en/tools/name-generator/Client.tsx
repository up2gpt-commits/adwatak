...
const relatedTools = [
  { title: "Random Number Generator", icon: "🎲", href: "/en/tools/random-number" },
  ...
  { title: "Bio Generator", icon: "✍️", href: "/en/tools/bio-generator" },
];
...
export default function Client() {
  ...
  const schemaName = "Name Generator";const schemaDesc = "Online Name Generator - free tool";const schemaCategory = "Utility";const schemaUrl = "https://adwatak.cloud/en/tools/name-generator";const breadcrumbItems = [{name:"Home",url:"https://adwatak.cloud/en"},{name:"Generators",url:"https://adwatak.cloud/en/category/generators"},{name:"Name Generator",url:"https://adwatak.cloud/en/tools/name-generator"}];
  return (
    <div className="max-w-[760px] mx-auto">
      <StructuredData data={toolSchema(schemaName, schemaDesc, schemaUrl, 'en', schemaCategory)} />
      <StructuredData data={faqSchema(faqs)} />
      <StructuredData data={breadcrumbSchema(breadcrumbItems)} />
      <StructuredData data={howToSchema("How to use the Name Generator","Generate creative names instantly in your browser. No registration required.",[{name:"Choose a category",text:"Select from 7 categories: Baby, Brand, Username, Business, Pet, Fantasy, or Startup"},{name:"Set the count",text:"Choose how many names to generate (1-20)"},{name:"Generate names",text:"Click the Generate button to get random creative names"},{name:"Copy and use",text:"Copy individual names or save them for your project"}],"less than a minute","en")} />
