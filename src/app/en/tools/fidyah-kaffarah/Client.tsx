...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      <StructuredData data={toolSchema("Fidyah & Kaffarah Calculator", "Calculate Fidyah & Kaffarah — oath breaking, Ramadan intimacy, Zhihar, fasting fidyah with Islamic rulings", "https://adwatak.cloud/en/tools/fidyah-kaffarah", "en", "Islamic")} />
      ...
      <RelatedTools tools={[
        ...
        { title: "Umrah Calculator", icon: "🕋", href: "/en/tools/umrah-calculator" },
