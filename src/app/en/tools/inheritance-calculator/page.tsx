...
export default function InheritanceCalculator() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{ name: "Home", url: "https://adwatak.cloud/en" }, { name: "Islamic Tools", url: "https://adwatak.cloud/en/tools/islamic" }, { name: "Inheritance Calculator", url: "https://adwatak.cloud/en/tools/inheritance-calculator" }])} />
