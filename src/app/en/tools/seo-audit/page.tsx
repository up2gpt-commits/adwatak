...
export default function SEOAudit() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{name:"Home",url:"https://adwatak.cloud/en"},{name:"Developer Tools",url:"https://adwatak.cloud/en/tools/dev"},{name:"SEO Audit",url:"https://adwatak.cloud/en/tools/seo-audit"}])} />
      <Breadcrumb lang="en" category="Developer Tools" categorySlug="dev" toolName="SEO Audit" />
