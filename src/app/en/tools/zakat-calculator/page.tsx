...
const schemaUrl = "https://adwatak.cloud/en/tools/zakat-calculator";
const breadcrumbItems = [
  { name: "Home", url: "https://adwatak.cloud/en" },
  { name: "Utility", url: "https://adwatak.cloud/en/tools/utility" },
  { name: "Zakat Calculator", url: "https://adwatak.cloud/en/tools/zakat-calculator" },
];
return (
    <div className="max-w-[760px] mx-auto">
      ...
      <Breadcrumb category="Islamic Calculators" categorySlug="calculators" toolName="Zakat Calculator" />
