...
<StructuredData data={breadcrumbSchema([{name:"Home",url:"https://adwatak.cloud/en"},{name:"Text Tools",url:"https://adwatak.cloud/en/tools/text"},{name:"Grammar Checker",url:"https://adwatak.cloud/en/tools/grammar-checker"}])}/>
