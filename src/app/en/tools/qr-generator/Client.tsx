...
const relatedTools = [
  ...
  { title: "Name Generator", icon: "👤", href: "/en/tools/name-generator" },
...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{ name: "Home", url: "https://adwatak.cloud/en" }, { name: "Dev Tools", url: "https://adwatak.cloud/en/category/dev" }, { name: "QR Code Generator", url: schemaUrl }])} />
