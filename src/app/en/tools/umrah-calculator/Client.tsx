...
export default function Client() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      <StructuredData data={toolSchema("Umrah Calculator", "Calculate total Umrah cost — visa, flight, accommodation, transport, daily expenses with step-by-step Umrah guide", "https://adwatak.cloud/en/tools/umrah-calculator", "en", "Islamic")} />
