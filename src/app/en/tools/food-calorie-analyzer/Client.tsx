...
const relatedTools = [
  {
    ...
    icon: "🔥",
    href: "/en/tools/calorie-calculator",
  },
  {
    title: "BMI Calculator",
    icon: "⚖️",
    href: "/en/tools/bmi-calculator",
  },
  { title: "Stopwatch", icon: "⏱️", href: "/en/tools/stopwatch" },
  { title: "Timer", icon: "⏰", href: "/en/tools/timer" },
];
    ...
    <div className="max-w-[760px] mx-auto">
      <StructuredData
        data={toolSchema(
          ...
          "https://adwatak.cloud/en/tools/food-calorie-analyzer",
          "en",
          "Health"
        )}
      />
      ...
      <StructuredData
        data={breadcrumbSchema([
          {
            name: "Home",
            url: "https://adwatak.cloud/en",
          },
          {
            name: "Other Tools",
            url: "https://adwatak.cloud/en/category/daily",
          },
          {
            name: "Food Calorie Analyzer",
            url: "https://adwatak.cloud/en/tools/food-calorie-analyzer",
          },
        ])}
      />
      <StructuredData
