...
export default function PlagiarismChecker() {
  ...
  return (
    <div className="max-w-[760px] mx-auto">
      ...
      <StructuredData data={breadcrumbSchema([{name:"Home",url:"https://adwatak.cloud/en"},{name:"Text Tools",url:"https://adwatak.cloud/en/tools/text"},{name:"Plagiarism Checker",url:"https://adwatak.cloud/en/tools/plagiarism-checker"}])} />
